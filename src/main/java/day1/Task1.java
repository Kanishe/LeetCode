...
9и более- “Многоэтажный дом”.Так же,необходимо учесть что может быть введено отрицательное значение,
...
public class Task1 {
    public static void main(String[] args) {
        ...
        if (floorCount >= 1 && floorCount <= 4) {
            ...
            System.out.printf("Middle-rise building");
        } else if (floorCount >= 9) {
            System.out.printf("High-rise building");
        }
        else  {
            System.out.println("incorrect rise of building");
        }
    }
}
